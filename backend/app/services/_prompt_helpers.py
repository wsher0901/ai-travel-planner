...
def build_plan_system_prompt(sliders: dict | None, user_timezone: str | None = None) -> str:
    ...
    body = (
        ...
        '  "destination_scenery": "cityscape" | "oceanscape" | "mountainscape" | "forestscape" | "plains",\n'
        '  // cityscape=urban; oceanscape=coastal/island; mountainscape=alpine/highland; forestscape=jungle/rainforest; plains=open terrain/savanna/desert\n'
